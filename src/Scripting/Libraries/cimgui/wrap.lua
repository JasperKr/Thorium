...
---@class SnapEngine.imgui
M = M

-- add metamethods to ImVec2 and ImVec4

local references = {}
function M.TextureRef(texture)
  local id = references[texture]
  if id then
    return id
  end
  local ref = ffi.new("ImTextureRef")
  ref._TexData = nil
  ref._TexID = ffi.cast("uint64_t", texture:getID())
  references[texture] = ref
  return ref
end
...
M.GetItemRectMax = M.GetItemRectMax or function(o1)
  jit.off(true)
  o1 = o1 or M.ImVec2_Nil()
  local out = C.igGetItemRectMax(o1)
  return o1, out
end
M.GetItemRectMin = M.GetItemRectMin or function(o1)
  jit.off(true)
  o1 = o1 or M.ImVec2_Nil()
...
M.GetMouseDragDelta = M.GetMouseDragDelta or function(i1, i2, o1)
  jit.off(true)
  if i1 == nil then i1 = 0 end
  if i2 == nil then i2 = -1.0 end
  o1 = o1 or M.ImVec2_Nil()
...
M.GetWindowPos = M.GetWindowPos or function(o1)
  jit.off(true)
  o1 = o1 or M.ImVec2_Nil()
  local out = C.igGetWindowPos(o1)
  return o1, out
end
M.GetWindowSize = M.GetWindowSize or function(o1)
  jit.off(true)
  o1 = o1 or M.ImVec2_Nil()
